package com.yuetsao.googleoauth.controller;

import com.yuetsao.googleoauth.utils.HttpClientUtil;
...
public class LoginController {
    ...
    private static String redirect_url = "http://localhost:8089/GoogleUserInfo";
